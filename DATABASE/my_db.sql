...
(56, 'lazartan', 'glenn', 'boxes', 'batch 1', 1, 1, '2030-12-12', 'available'),
(59, 'Pills', 'Kirt', 'tablet', 'Batch 1', 0, 99, '2029-10-24', 'available');
...
INSERT INTO `users` (`id`, `username`, `password`, `fname`, `lname`, `usertype`, `address`, `mobile_number`, `photo`) VALUES
(26, 'admin@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 'adminn', 'admin', 1, 'ambulong', '09231232324', 'profile.jpg'),
(81, 'bhw@gmail.com', '6adcff9bb6c324d349dfd67c82e1e832', 'bhw', 'bhw', 2, 'malitam dos', '0913892839', '');
...
--
ALTER TABLE `request_medicine`
  MODIFY `req_med_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT for table `residentrecords`
--
ALTER TABLE `residentrecords`
  MODIFY `residentId` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=273;
